...
namespace HexTerra
{
    ...
    public static class HexMath
    {
        ...
        // Neighbour directions, clockwise from the top edge. The index doubles as the wall
        ...
        public static Vector3Int ToCube(Vector2Int axial) =>
            new(axial.x, -axial.x - axial.y, axial.y);

        public static Vector2Int ToAxial(Vector3Int cube) =>
            new(cube.x, cube.z);
        ...
        public static Vector3 ToWorld(float q, float r) =>
            new(ColumnSpacing * q, 0f, RowHalf * (q + 2f * r));
